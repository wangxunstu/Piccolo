...
namespace Piccolo
{
    void SimplePass::initialize(const RenderPassInitInfo* init_info)
    {
        RenderPass::initialize(nullptr);

        const SimplePassInitInfo* _init_info = static_cast<const SimplePassInitInfo*>(init_info);
    ...
    void SimplePass::setupDescriptorSetLayout()
    {
    ...
    void SimplePass::setupPipelines()
    {
        ...
        RHIShader* frag_shader_module = m_rhi->createShaderModule(SIMPLE_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_simple_pass;
    ...
    void SimplePass::setupDescriptorSet()
    {
    ...
    void SimplePass::updateAfterFramebufferRecreate(RHIImageView* input_attachment)
    {
    ...
    void SimplePass::draw()
    {
        float color[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
        m_rhi->pushEvent(m_rhi->getCurrentCommandBuffer(), "Simple Pass", color);
