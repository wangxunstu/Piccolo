#include "runtime/function/render/passes/downsample_pass.h"
#include "runtime/function/render/interface/vulkan/vulkan_rhi.h"
#include "runtime/function/render/interface/vulkan/vulkan_util.h"

#include <fxaa_vert.h>
#include <downsample_frag.h>

#include <stdexcept>

namespace Piccolo
{
    void DownSamplePass::initialize(const RenderPassInitInfo* init_info)
    {
        RenderPass::initialize(nullptr);

        const DownSamplePassInitInfo* _init_info = static_cast<const DownSamplePassInitInfo*>(init_info);
    ...
    void DownSamplePass::setupDescriptorSetLayout()
    {
        ...
        post_process_global_layout_input_attachment_binding.descriptorType  = RHI_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    ...
    void DownSamplePass::setupPipelines()
    {
        ...
        RHIShader* frag_shader_module = m_rhi->createShaderModule(DOWNSAMPLE_FRAG);
        ...
        pipelineInfo.subpass = _main_camera_subpass_downsample_pass;
    ...
    void DownSamplePass::setupDescriptorSet()
    {
    ...
    void DownSamplePass::updateAfterFramebufferRecreate(RHIImageView* input_attachment)
    {
    ...
    void DownSamplePass::draw()
    {
		float color[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
		m_rhi->pushEvent(m_rhi->getCurrentCommandBuffer(), "DownSmample", color);
